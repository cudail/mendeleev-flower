...
d.append(svg.Text("Inspired by Ian Taylor's mendeleev flower: https://chilliant.blogspot.com/2013/06/helical-periodic-table.html",12,670,-423,font_family='sans-serif',fill='black',text_anchor='end'))
d.append(svg.Text("Element data from: https://gist.github.com/GoodmanSciences/c2dd862cd38f21b0ad36b8f96b4bf1ee",12,670,-440,font_family='sans-serif',fill='black',text_anchor='end'))
d.append(svg.Text("Colours based on Paul Tol's colour palettes: https://personal.sron.nl/~pault/",12,670,-457,font_family='sans-serif',fill='black',text_anchor='end'))
